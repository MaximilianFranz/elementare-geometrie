...
% ---------------------------------------------------------------------------------------
% TODO: Ersetze X durch richitges Symbol
%----------------------------------------------------------------------------------------
...
Die Eulercharakteristik $ X(M) $ ist definiert als $ X(K) $, $ X(M) $ hängt also nicht von $ (K,t) $ ab.
...
M_1 \# M_2 \underset{ \text{ Lemma 2 } }{ \cong } \vert K_1 \vert \# \vert K_2 \vert
 ...
 %----------------------------------------------------------------------------------------
 \begin{align*}
   % s(K) &= s(K_1) + s(K_2) - 2 $ da die Dreiecke fehlen$\\
   % k(K) &= k(K_1) + k(K_2) - 3 $ da drei Kantenpaare verklebt wurden$\\
   % e(K) &= e(K_1) + e(K_2) - 3 $ da drei Eckenpaare verklebt wurden$
 \end{align*}
 Also ist 
